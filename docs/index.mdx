...
import { NotebookPen, PlusCircle, Search } from 'lucide-react';
...
<Steps>
  ...
  <Step>
    **Learn the core features**: continue with [Add Context](/docs/add-context), [Literature Search](/docs/literature-search), and [Save as Note](/docs/save-as-note).
  </Step>
  <Step>
