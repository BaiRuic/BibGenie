...
- Paid plans add **Web Search** and **Web Extract** for reading public web sources beyond your library.
...
- **Pro / Max / Lifetime** provide larger official-model allowances; paid plans include Web Search / Web Extract.
